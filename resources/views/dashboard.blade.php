...
{{-- 
    ...
    @if(session('toast'))
    <div id="toast-top-right" class="fixed flex items-center w-full max-w-xs p-1 space-x-4 text-gray-500 bg-white divide-x divide-gray-200 rounded-lg shadow top-5 right-5 dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800" role="alert">
        <div class="flex items-center p-4 mb-1 text-md text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800" role="alert">
                                            ...
                                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                                ...
                                                @if ($arizalar)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{{ $ariza->yonalish }}</td>
                                                        <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                            <div class="flex items-center gap-x-2">
                                                                <p class="px-3 py-1 text-xs text-indigo-500 rounded-full dark:bg-gray-800 bg-indigo-100/60">{{ $ariza->created_at->diffForHumans() }}</p>
