                                                    ...
                                                    <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                                        <div class="inline-flex items-center gap-x-3">
                                                            <div class="flex items-center gap-x-2">
                                                                ...
                                                                <div>
                                                                    <h2 class="font-medium text-gray-800  ">{{ $admin->name }}</h2>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                        <div class="flex items-center gap-x-6">
                                                            <form action="{{ route('adminDelete', $admin->id) }}" method="POST"
                                                                ...
                                                                <button onclick="openModal({{ $admin->id }})" type="button" class="text-gray-500 transition-colors duration-200   hover:text-red-500 focus:outline-none" onclick="openModal()">
