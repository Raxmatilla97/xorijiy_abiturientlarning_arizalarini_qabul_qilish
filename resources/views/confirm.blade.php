...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">
  ...
  >
    ...
    <div class="flex flex-col justify-center p-6 pb-12">
        ...
        <div class="mt-6 bg-white/80 p-4 sm:p-5 backdrop-blur-xl sm:mt-10 mx-auto rounded-xl shadow-xl w-full max-w-xl">
            ...
            <div class="max-w-2xl overflow-hidden bg-white rounded-lg shadow-md ">
                ...
                <div class="p-6">
                    <div>
                        <span class="text-xs font-medium text-blue-600 uppercase ">Ariza joylandi!</span>
                        <p class="block mt-2 pb-4 text-center text-xl font-semibold normal-case text-gray-800 transition-colors duration-300 transform  hover:text-gray-600 hover:underline" tabindex="0" role="link">
                        ...
                        <p class="mt-2 text-md text-gray-600 ">
                            Hurmatli abituriyent siz jo'natgan ariza bizgacha yetib keldi, uni tez kunda ko'rib chiqib bu haqda izoh qoldiramiz, arizangizni holatini tekshirish uchun ID raqamdan foydalanishingiz mumkin. <p class="text-gray-800 text-xl text-center mt-3">ID raqamni esdan chiqarmang!</p>
                        </p>
                    </div>

                    <div class="flex items-center justify-between w-full mt-5 gap-x-2">
                         <input type="text" onclick="copyText()" id="myInput" disabled value="" class="flex-1 block h-10 px-4 text-xl text-gray-700 text-center bg-white border border-gray-200 rounded-md focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40  focus:outline-none focus:ring" />

                        <button id="copyBtn"  onclick="copyText()" class="rounded-md hidden sm:block p-1.5 text-gray-700 bg-white border border-gray-200  focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40  focus:outline-none focus:ring transition-colors duration-300 hover:text-blue-500 ">
                    ...
                    <div class="mt-4 text-center sm:flex sm:items-center sm:justify-between sm:mt-6 sm:-mx-2">
                        <a href="{{ '/' }}"  class="px-4 sm:mx-2 block w-full py-2.5 text-sm font-medium tracking-wide text-gray-700 capitalize transition-colors duration-300 transform border border-gray-200 rounded-md hover:bg-gray-100 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-40">
    ...
    <div class="font-bold">
      ...
      <span class="block text-sm text-gray-500 sm:text-center ">© 2023 <a href="https://cspi.uz/" class="hover:underline">CSPU</a>. All Rights Reserved. Fayziyev.R | Laravel v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }})</span>
...
<div id="modal" class="hidden fixed inset-0 flex items-center justify-center z-50">
  ...
  <div class="bg-white z-0 rounded-lg p-4">
    <div class="flex w-50 max-w-sm overflow-hidden bg-white rounded-lg shadow-md ">
      ...
      <div class="px-4 py-2 -mx-3">
          <div class="mx-3">
              <span class="font-semibold text-emerald-500 ">Nusxa olindi: <span id="copiedText"></span></span>
              <p class="text-sm text-gray-600 ">ID raqamni saqlab qo'ying!</p>
          </div>
      </div>
    </div>
