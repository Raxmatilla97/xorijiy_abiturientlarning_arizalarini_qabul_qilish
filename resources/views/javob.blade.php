            ...
            <div class="max-w-2xl overflow-hidden bg-white rounded-lg shadow-md ">
                ...
                <div class="p-6">
                    <div>
                        ...
                        <p class="block mt-2 pb-4 text-center text-[24px] font-semibold capitalize text-gray-800 transition-colors duration-300 transform hover:text-gray-600 hover:underline" tabindex="0" role="link">
                           @if ($hulosa)
                                {{ $hulosa['fish']}}
                           @endif
                           <br>
                        ...
                        <p class="mt-6 p-4 text-md border border-gray-200 rounded-md text-gray-600 ">

                            @if ($hulosa['message'] == null)
                                Hurmatli abituriyent {{ $hulosa['fish']}} sizning arizangiz ayni damda tekshirish jarayonida va tez orada arizangiz ko'rib chiqiladi!
                            @else
                                {{ $hulosa['message']}}
                            @endif
                    ...
                    <div class="mt-4 sm:flex sm:items-center sm:justify-between sm:mt-6 sm:-mx-2">
                        <a href="{{ '/' }}">
                            <button  class="px-4 sm:mx-2 w-full py-2.5 text-sm font-medium tracking-wide capitalize transition-colors duration-300 transform border border-gray-200 rounded-md hover:bg-gray-100 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-40">
            ...
            <div class="max-w-2xl overflow-hidden bg-white rounded-lg shadow-md ">
                ...
                <div class="p-6">
                    <div>
                        ...
                        <p class="mt-2 p-4 text-md text-gray-600 ">
                            Kechirasi siz qidirgan ID raqam bo'yicha ariza topilmadi! ID raqam to'g'riligini tekshirib ko'ring.
                        </p>
                    </div>
                    <div class="mt-4 sm:flex sm:items-center sm:justify-between sm:mt-6 sm:-mx-2">
                        <a href="{{ '/' }}">
                            <button  class="px-4 sm:mx-2 w-full py-2.5 text-sm font-medium tracking-wide text-gray-700 capitalize transition-colors duration-300 transform border border-gray-200 rounded-md hover:bg-gray-100 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-40">
                            Ariza sahifasiga qaytish
                            </button>
                        </a>
