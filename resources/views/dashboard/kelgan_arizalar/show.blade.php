                                            ...
                                            <table class="min-w-full divide-y divide-gray-200 ">
                                                ...
                                                <tbody class="bg-white divide-y divide-gray-200  ">
                                                    ...
                                                    <tr>
                                                        <td
                                                            ...
                                                            <div class="inline-flex items-center gap-x-3">
                                                                ...
                                                                <div class="flex items-center gap-x-2">
                                                                    ...
                                                                    <div>
                                                                        <h2 class="font-normal text-gray-800  ">O'qish joyi va ish joyi:</h2>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td
                                                            class="px-12 py-4 text-lg font-normal text-gray-700 whitespace-wrap">
                                                            <span class="font-semibold text-gray-900">Qaysi ta'lim muassasasini bitirgansiz?:</span>
                                                            {{ $ariza->name_of_educational }} <br>
                                                            <span class="font-semibold text-gray-900">Ta'lim muassasasini qaysi yili bitirgan:</span>
                                                            {{ $ariza->year_of_educational }}  <br>
                                                            <span class="font-semibold text-gray-900">Qaysi yo'nalishda bitirgan:</span>
                                                            {{ $ariza->direction_of_educational }}
                                                            <hr class="my-4 border-gray-300">
                                                            <span class="font-semibold text-gray-900">Diplom seriyasi va raqami:</span>
                                                            {{ $ariza->seriya_of_educational }} -
                                                            {{ $ariza->number_of_educational }}

                                                            <hr class="my-4 border-gray-300">
                                                            <span class="font-semibold text-gray-900">Qaysi chet tillarini bildi:</span>
                                                            {{ $ariza->language_i_know }} <br>
                                                            <hr class="my-4 border-gray-300">
                                                            <span class="font-semibold text-gray-900">Ishlagan tashkilot va ishlagan muddati:</span>
                                                            {{ $ariza->where_i_worked }} <br>
